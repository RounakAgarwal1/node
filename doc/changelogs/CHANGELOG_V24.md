...
* \[[`feedfd5827`](https://github.com/nodejs/node/commit/feedfd5827)] - **(SEMVER-MINOR)** **async\_hooks**: add trackPromises option to createHook() (Joyee Cheung) [#61415](https://github.com/nodejs/node/pull/61415)
* \[[`5cfc06522c`](https://github.com/nodejs/node/commit/5cfc06522c)] - **build,deps**: replace cjs-module-lexer with merve (Yagiz Nizipli) [#61456](https://github.com/nodejs/node/pull/61456)
* \[[`943e5b4ca8`](https://github.com/nodejs/node/commit/943e5b4ca8)] - **(SEMVER-MINOR)** **deps**: add LIEF as a dependency (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`75d7fc26dd`](https://github.com/nodejs/node/commit/75d7fc26dd)] - **(SEMVER-MINOR)** **deps**: add tools and scripts to pull LIEF as a dependency (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`fa46e8f65e`](https://github.com/nodejs/node/commit/fa46e8f65e)] - **(SEMVER-MINOR)** **events**: repurpose `events.listenerCount()` to accept EventTargets (René) [#60214](https://github.com/nodejs/node/pull/60214)
* \[[`bbd6307076`](https://github.com/nodejs/node/commit/bbd6307076)] - **(SEMVER-MINOR)** **fs**: add ignore option to fs.watch (Matteo Collina) [#61433](https://github.com/nodejs/node/pull/61433)
* \[[`7424eaa8ff`](https://github.com/nodejs/node/commit/7424eaa8ff)] - **(SEMVER-MINOR)** **http**: add http.setGlobalProxyFromEnv() (Joyee Cheung) [#60953](https://github.com/nodejs/node/pull/60953)
* \[[`1cf109d6da`](https://github.com/nodejs/node/commit/1cf109d6da)] - **(SEMVER-MINOR)** **module**: allow subpath imports that start with `#/` (Jan Martin) [#60864](https://github.com/nodejs/node/pull/60864)
* \[[`a18cd1d117`](https://github.com/nodejs/node/commit/a18cd1d117)] - **(SEMVER-MINOR)** **process**: preserve AsyncLocalStorage in queueMicrotask only when needed (Gürgün Dayıoğlu) [#60913](https://github.com/nodejs/node/pull/60913)
* \[[`2524612f68`](https://github.com/nodejs/node/commit/2524612f68)] - **(SEMVER-MINOR)** **sea**: split sea binary manipulation code (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`1967aec35e`](https://github.com/nodejs/node/commit/1967aec35e)] - **(SEMVER-MINOR)** **sqlite**: enable defensive mode by default (Bart Louwers) [#61266](https://github.com/nodejs/node/pull/61266)
* \[[`655d2bc32a`](https://github.com/nodejs/node/commit/655d2bc32a)] - **(SEMVER-MINOR)** **sqlite**: add sqlite prepare options args (Guilherme Araújo) [#61311](https://github.com/nodejs/node/pull/61311)
* \[[`73c213db29`](https://github.com/nodejs/node/commit/73c213db29)] - **(SEMVER-MINOR)** **src**: add initial support for ESM in embedder API (Joyee Cheung) [#61548](https://github.com/nodejs/node/pull/61548)
* \[[`1b9d2a0889`](https://github.com/nodejs/node/commit/1b9d2a0889)] - **(SEMVER-MINOR)** **stream**: add bytes() method to stream/consumers (wantaek) [#60426](https://github.com/nodejs/node/pull/60426)
* \[[`239bf340ec`](https://github.com/nodejs/node/commit/239bf340ec)] - **(SEMVER-MINOR)** **stream**: do not pass `readable.compose()` output via `Readable.from()` (René) [#60907](https://github.com/nodejs/node/pull/60907)
* \[[`7a95dffabb`](https://github.com/nodejs/node/commit/7a95dffabb)] - **(SEMVER-MINOR)** **test**: use fixture directories for sea tests (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`ce4cc0a041`](https://github.com/nodejs/node/commit/ce4cc0a041)] - **(SEMVER-MINOR)** **test\_runner**: add env option to run function (Ethan Arrowood) [#61367](https://github.com/nodejs/node/pull/61367)
* \[[`bae6111785`](https://github.com/nodejs/node/commit/bae6111785)] - **(SEMVER-MINOR)** **test\_runner**: support expecting a test-case to fail (Jacob Smith) [#60669](https://github.com/nodejs/node/pull/60669)
* \[[`5f18ad31e2`](https://github.com/nodejs/node/commit/5f18ad31e2)] - **(SEMVER-MINOR)** **util**: add convertProcessSignalToExitCode utility (Erick Wendel) [#60963](https://github.com/nodejs/node/pull/60963)

### Commits

* \[[`d4c6fcb5e4`](https://github.com/nodejs/node/commit/d4c6fcb5e4)] - **assert**: fix loose deepEqual arrays with undefined and null failing (Ruben Bridgewater) [#61587](https://github.com/nodejs/node/pull/61587)
* \[[`feedfd5827`](https://github.com/nodejs/node/commit/feedfd5827)] - **(SEMVER-MINOR)** **async\_hooks**: add trackPromises option to createHook() (Joyee Cheung) [#61415](https://github.com/nodejs/node/pull/61415)
* \[[`9975bd81f1`](https://github.com/nodejs/node/commit/9975bd81f1)] - **benchmark**: add streaming TextDecoder benchmark (Сковорода Никита Андреевич) [#61549](https://github.com/nodejs/node/pull/61549)
* \[[`60bf051e37`](https://github.com/nodejs/node/commit/60bf051e37)] - **build**: skip sscache action on non-main branches (Joyee Cheung) [#61790](https://github.com/nodejs/node/pull/61790)
* \[[`cd2afa6176`](https://github.com/nodejs/node/commit/cd2afa6176)] - **build**: add `--shared-nbytes` configure flag (Antoine du Hamel) [#61341](https://github.com/nodejs/node/pull/61341)
* \[[`9e6b305e28`](https://github.com/nodejs/node/commit/9e6b305e28)] - **build**: add `--shared-hdr-histogram` configure flag (Antoine du Hamel) [#61280](https://github.com/nodejs/node/pull/61280)
* \[[`009471590e`](https://github.com/nodejs/node/commit/009471590e)] - **build**: add `--shared-gtest` configure flag (Antoine du Hamel) [#61279](https://github.com/nodejs/node/pull/61279)
* \[[`a4fc77781f`](https://github.com/nodejs/node/commit/a4fc77781f)] - **build**: aix: deoptimize implementation-visitor.cc with --shared (Stewart X Addison) [#61550](https://github.com/nodejs/node/pull/61550)
* \[[`5cfc06522c`](https://github.com/nodejs/node/commit/5cfc06522c)] - **build,deps**: replace cjs-module-lexer with merve (Yagiz Nizipli) [#61456](https://github.com/nodejs/node/pull/61456)
* \[[`1a9daa3d49`](https://github.com/nodejs/node/commit/1a9daa3d49)] - **deps**: upgrade npm to 11.9.0 (npm team) [#61685](https://github.com/nodejs/node/pull/61685)
* \[[`8bdb112a75`](https://github.com/nodejs/node/commit/8bdb112a75)] - **deps**: update amaro to 1.1.7 (Node.js GitHub Bot) [#61730](https://github.com/nodejs/node/pull/61730)
* \[[`bc19ba9d7e`](https://github.com/nodejs/node/commit/bc19ba9d7e)] - **deps**: update minimatch to 10.1.2 (Node.js GitHub Bot) [#61732](https://github.com/nodejs/node/pull/61732)
* \[[`b607f04dd3`](https://github.com/nodejs/node/commit/b607f04dd3)] - **deps**: update undici to 7.21.0 (Node.js GitHub Bot) [#61683](https://github.com/nodejs/node/pull/61683)
* \[[`42c00259c4`](https://github.com/nodejs/node/commit/42c00259c4)] - **deps**: update googletest to 56efe3983185e3f37e43415d1afa97e3860f187f (Node.js GitHub Bot) [#61605](https://github.com/nodejs/node/pull/61605)
* \[[`3587fdf69a`](https://github.com/nodejs/node/commit/3587fdf69a)] - **deps**: update amaro to 1.1.6 (Node.js GitHub Bot) [#61603](https://github.com/nodejs/node/pull/61603)
* \[[`943e5b4ca8`](https://github.com/nodejs/node/commit/943e5b4ca8)] - **(SEMVER-MINOR)** **deps**: add LIEF as a dependency (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`75d7fc26dd`](https://github.com/nodejs/node/commit/75d7fc26dd)] - **(SEMVER-MINOR)** **deps**: add tools and scripts to pull LIEF as a dependency (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`b6cb8cd918`](https://github.com/nodejs/node/commit/b6cb8cd918)] - **deps**: V8: cherry-pick highway\@dcc0ca1cd42 (Richard Lau) [#61008](https://github.com/nodejs/node/pull/61008)
...
* \[[`29f6eb56da`](https://github.com/nodejs/node/commit/29f6eb56da)] - **dns**: fix Windows SRV ECONNREFUSED by adjusting c-ares fallback detection (notvivek12) [#61453](https://github.com/nodejs/node/pull/61453)
* \[[`fcab7875cc`](https://github.com/nodejs/node/commit/fcab7875cc)] - **doc**: clarify EventEmitter error handling in threat model (Matteo Collina) [#61701](https://github.com/nodejs/node/pull/61701)
* \[[`ed9a93bca3`](https://github.com/nodejs/node/commit/ed9a93bca3)] - **doc**: mention default option for test runner env (Steven) [#61659](https://github.com/nodejs/node/pull/61659)
* \[[`19a64cb2e3`](https://github.com/nodejs/node/commit/19a64cb2e3)] - **doc**: fix --inspect security warning section (Tim Perry) [#61675](https://github.com/nodejs/node/pull/61675)
* \[[`85a7494b8c`](https://github.com/nodejs/node/commit/85a7494b8c)] - **doc**: document `url.format(urlString)` as deprecated under DEP0169 (René) [#61644](https://github.com/nodejs/node/pull/61644)
* \[[`c57cd3397a`](https://github.com/nodejs/node/commit/c57cd3397a)] - **doc**: deprecation add more codemod (Augustin Mauroy) [#61642](https://github.com/nodejs/node/pull/61642)
* \[[`b9356459b8`](https://github.com/nodejs/node/commit/b9356459b8)] - **doc**: fix grammatical error in README.md (ayj8201) [#61653](https://github.com/nodejs/node/pull/61653)
* \[[`72a920bf19`](https://github.com/nodejs/node/commit/72a920bf19)] - **doc**: correct tools README Boxstarter link (Mike McCready) [#61638](https://github.com/nodejs/node/pull/61638)
* \[[`c276a46405`](https://github.com/nodejs/node/commit/c276a46405)] - **doc**: update `server.dropMaxConnection` link (YuSheng Chen) [#61584](https://github.com/nodejs/node/pull/61584)
* \[[`3b27cc8dd5`](https://github.com/nodejs/node/commit/3b27cc8dd5)] - **doc**: clean up writing-and-running-benchmarks.md (Hardanish Singh) [#61345](https://github.com/nodejs/node/pull/61345)
* \[[`fa46e8f65e`](https://github.com/nodejs/node/commit/fa46e8f65e)] - **(SEMVER-MINOR)** **events**: repurpose `events.listenerCount()` to accept EventTargets (René) [#60214](https://github.com/nodejs/node/pull/60214)
* \[[`bbd6307076`](https://github.com/nodejs/node/commit/bbd6307076)] - **(SEMVER-MINOR)** **fs**: add ignore option to fs.watch (Matteo Collina) [#61433](https://github.com/nodejs/node/pull/61433)
* \[[`c940fd5883`](https://github.com/nodejs/node/commit/c940fd5883)] - **http**: implement slab allocation for HTTP header parsing (Mert Can Altin) [#61375](https://github.com/nodejs/node/pull/61375)
* \[[`7424eaa8ff`](https://github.com/nodejs/node/commit/7424eaa8ff)] - **(SEMVER-MINOR)** **http**: add http.setGlobalProxyFromEnv() (Joyee Cheung) [#60953](https://github.com/nodejs/node/pull/60953)
* \[[`c44e0175fe`](https://github.com/nodejs/node/commit/c44e0175fe)] - **lib**: use utf8 fast path for streaming TextDecoder (Сковорода Никита Андреевич) [#61549](https://github.com/nodejs/node/pull/61549)
* \[[`e6e829c6a0`](https://github.com/nodejs/node/commit/e6e829c6a0)] - **lib**: recycle queues (Robert Nagy) [#61461](https://github.com/nodejs/node/pull/61461)
* \[[`60d74d5ec6`](https://github.com/nodejs/node/commit/60d74d5ec6)] - **lib**: use StringPrototypeStartsWith from primordials in locks (Taejin Kim) [#61492](https://github.com/nodejs/node/pull/61492)
* \[[`bab6374e60`](https://github.com/nodejs/node/commit/bab6374e60)] - **lib**: unify ICU and no-ICU TextDecoder (Сковорода Никита Андреевич) [#61409](https://github.com/nodejs/node/pull/61409)
* \[[`1ad165a6ab`](https://github.com/nodejs/node/commit/1ad165a6ab)] - **lib**: prefer `call()` over `apply()` if argument list is not array (Livia Medeiros) [#60796](https://github.com/nodejs/node/pull/60796)
* \[[`b764b84b2c`](https://github.com/nodejs/node/commit/b764b84b2c)] - **lib**: add support for readable byte streams to .toWeb() (Hans Klunder) [#58664](https://github.com/nodejs/node/pull/58664)
* \[[`c04af9a5a1`](https://github.com/nodejs/node/commit/c04af9a5a1)] - **meta**: persist sccache daemon until end of build workflows (René) [#61639](https://github.com/nodejs/node/pull/61639)
* \[[`6a2f81e05b`](https://github.com/nodejs/node/commit/6a2f81e05b)] - **meta**: bump github/codeql-action from 4.31.9 to 4.32.0 (dependabot\[bot]) [#61622](https://github.com/nodejs/node/pull/61622)
* \[[`3746b7e9ee`](https://github.com/nodejs/node/commit/3746b7e9ee)] - **meta**: bump step-security/harden-runner from 2.14.0 to 2.14.1 (dependabot\[bot]) [#61621](https://github.com/nodejs/node/pull/61621)
* \[[`8979e8a865`](https://github.com/nodejs/node/commit/8979e8a865)] - **meta**: bump actions/setup-python from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61627](https://github.com/nodejs/node/pull/61627)
* \[[`2d5ef8101e`](https://github.com/nodejs/node/commit/2d5ef8101e)] - **meta**: bump actions/setup-node from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61625](https://github.com/nodejs/node/pull/61625)
* \[[`ecd93efb54`](https://github.com/nodejs/node/commit/ecd93efb54)] - **meta**: bump actions/cache from 5.0.1 to 5.0.3 (dependabot\[bot]) [#61624](https://github.com/nodejs/node/pull/61624)
* \[[`f3d7a38934`](https://github.com/nodejs/node/commit/f3d7a38934)] - **meta**: bump peter-evans/create-pull-request from 8.0.0 to 8.1.0 (dependabot\[bot]) [#61623](https://github.com/nodejs/node/pull/61623)
* \[[`4b62aa8f08`](https://github.com/nodejs/node/commit/4b62aa8f08)] - **meta**: bump actions/stale from 10.1.0 to 10.1.1 (dependabot\[bot]) [#61620](https://github.com/nodejs/node/pull/61620)
* \[[`a27eef9c73`](https://github.com/nodejs/node/commit/a27eef9c73)] - **meta**: bump actions/checkout from 6.0.1 to 6.0.2 (dependabot\[bot]) [#61619](https://github.com/nodejs/node/pull/61619)
* \[[`a0c992cfc7`](https://github.com/nodejs/node/commit/a0c992cfc7)] - **meta**: bump actions/download-artifact from 6.0.0 to 7.0.0 (dependabot\[bot]) [#61242](https://github.com/nodejs/node/pull/61242)
* \[[`7285f16e2b`](https://github.com/nodejs/node/commit/7285f16e2b)] - **meta**: bump actions/checkout from 6.0.0 to 6.0.1 (dependabot\[bot]) [#61239](https://github.com/nodejs/node/pull/61239)
* \[[`dffba04624`](https://github.com/nodejs/node/commit/dffba04624)] - **meta**: bump actions/upload-artifact from 5.0.0 to 6.0.0 (dependabot\[bot]) [#61238](https://github.com/nodejs/node/pull/61238)
* \[[`fa8b635b67`](https://github.com/nodejs/node/commit/fa8b635b67)] - **meta**: bump actions/checkout from 5.0.1 to 6.0.0 (dependabot\[bot]) [#60925](https://github.com/nodejs/node/pull/60925)
* \[[`f999960ee8`](https://github.com/nodejs/node/commit/f999960ee8)] - **meta**: bump actions/checkout from 5.0.0 to 5.0.1 (dependabot\[bot]) [#60767](https://github.com/nodejs/node/pull/60767)
* \[[`875dd5b819`](https://github.com/nodejs/node/commit/875dd5b819)] - **module**: do not invoke resolve hooks twice for imported cjs (Joyee Cheung) [#61529](https://github.com/nodejs/node/pull/61529)
* \[[`3cbd36ac51`](https://github.com/nodejs/node/commit/3cbd36ac51)] - **module**: do not wrap module.\_load when tracing is not enabled (Joyee Cheung) [#61479](https://github.com/nodejs/node/pull/61479)
* \[[`1cf109d6da`](https://github.com/nodejs/node/commit/1cf109d6da)] - **(SEMVER-MINOR)** **module**: allow subpath imports that start with `#/` (Jan Martin) [#60864](https://github.com/nodejs/node/pull/60864)
* \[[`0d1943af73`](https://github.com/nodejs/node/commit/0d1943af73)] - **net**: defer synchronous destroy calls in internalConnect (RajeshKumar11) [#61658](https://github.com/nodejs/node/pull/61658)
* \[[`924d9a5ceb`](https://github.com/nodejs/node/commit/924d9a5ceb)] - **process**: do not truncate long strings in `--print` (Mohamed Akram) [#61497](https://github.com/nodejs/node/pull/61497)
* \[[`a18cd1d117`](https://github.com/nodejs/node/commit/a18cd1d117)] - **(SEMVER-MINOR)** **process**: preserve AsyncLocalStorage in queueMicrotask only when needed (Gürgün Dayıoğlu) [#60913](https://github.com/nodejs/node/pull/60913)
* \[[`bdae3301d9`](https://github.com/nodejs/node/commit/bdae3301d9)] - **repl**: fix getters triggering side effects during completion (Dario Piotrowicz) [#61043](https://github.com/nodejs/node/pull/61043)
* \[[`80d6a48d74`](https://github.com/nodejs/node/commit/80d6a48d74)] - **repl**: tab completion targets `<class>` instead of `new <class>` (Đỗ Trọng Hải) [#60319](https://github.com/nodejs/node/pull/60319)
* \[[`2524612f68`](https://github.com/nodejs/node/commit/2524612f68)] - **(SEMVER-MINOR)** **sea**: split sea binary manipulation code (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`901cfd76ac`](https://github.com/nodejs/node/commit/901cfd76ac)] - **sqlite**: avoid extra copy for large text binds (Ali Hassan) [#61580](https://github.com/nodejs/node/pull/61580)
* \[[`fbb4756a61`](https://github.com/nodejs/node/commit/fbb4756a61)] - **sqlite**: use DictionaryTemplate for run() result (Mert Can Altin) [#61432](https://github.com/nodejs/node/pull/61432)
* \[[`4db719b912`](https://github.com/nodejs/node/commit/4db719b912)] - **sqlite**: change approach to fix segfault SQLTagStore (Bart Louwers) [#60462](https://github.com/nodejs/node/pull/60462)
* \[[`f292042df1`](https://github.com/nodejs/node/commit/f292042df1)] - **sqlite**: reserve vectors space (Guilherme Araújo) [#61540](https://github.com/nodejs/node/pull/61540)
* \[[`1967aec35e`](https://github.com/nodejs/node/commit/1967aec35e)] - **(SEMVER-MINOR)** **sqlite**: enable defensive mode by default (Bart Louwers) [#61266](https://github.com/nodejs/node/pull/61266)
* \[[`655d2bc32a`](https://github.com/nodejs/node/commit/655d2bc32a)] - **(SEMVER-MINOR)** **sqlite**: add sqlite prepare options args (Guilherme Araújo) [#61311](https://github.com/nodejs/node/pull/61311)
* \[[`ef61bc925d`](https://github.com/nodejs/node/commit/ef61bc925d)] - **src**: elide heap allocation in structured clone implementation (Anna Henningsen) [#61703](https://github.com/nodejs/node/pull/61703)
* \[[`0958855fb8`](https://github.com/nodejs/node/commit/0958855fb8)] - **src**: use simdutf for one-byte string UTF-8 write in stringBytes (Mert Can Altin) [#61696](https://github.com/nodejs/node/pull/61696)
* \[[`73c213db29`](https://github.com/nodejs/node/commit/73c213db29)] - **(SEMVER-MINOR)** **src**: add initial support for ESM in embedder API (Joyee Cheung) [#61548](https://github.com/nodejs/node/pull/61548)
* \[[`6a7461a3f6`](https://github.com/nodejs/node/commit/6a7461a3f6)] - **src**: throw RangeError on failed ArrayBuffer BackingStore allocation (Chengzhong Wu) [#61480](https://github.com/nodejs/node/pull/61480)
* \[[`1b9d2a0889`](https://github.com/nodejs/node/commit/1b9d2a0889)] - **(SEMVER-MINOR)** **stream**: add bytes() method to stream/consumers (wantaek) [#60426](https://github.com/nodejs/node/pull/60426)
* \[[`239bf340ec`](https://github.com/nodejs/node/commit/239bf340ec)] - **(SEMVER-MINOR)** **stream**: do not pass `readable.compose()` output via `Readable.from()` (René) [#60907](https://github.com/nodejs/node/pull/60907)
* \[[`cd5ddd1e52`](https://github.com/nodejs/node/commit/cd5ddd1e52)] - **test**: restraint version replacement pattern in snapshots (Chengzhong Wu) [#61748](https://github.com/nodejs/node/pull/61748)
* \[[`0431ee9858`](https://github.com/nodejs/node/commit/0431ee9858)] - **test**: print stack immediately avoiding GC interleaving (Chengzhong Wu) [#61699](https://github.com/nodejs/node/pull/61699)
* \[[`8fac12f780`](https://github.com/nodejs/node/commit/8fac12f780)] - **test**: fix case-insensitive path matching on Windows (Matteo Collina) [#61682](https://github.com/nodejs/node/pull/61682)
* \[[`48a430412d`](https://github.com/nodejs/node/commit/48a430412d)] - **test**: fix flaky test-performance-eventloopdelay (Matteo Collina) [#61629](https://github.com/nodejs/node/pull/61629)
* \[[`93c083c08f`](https://github.com/nodejs/node/commit/93c083c08f)] - **test**: remove duplicate wpt tests (Filip Skokan) [#61617](https://github.com/nodejs/node/pull/61617)
* \[[`29f2baa472`](https://github.com/nodejs/node/commit/29f2baa472)] - **test**: fix race condition in watch mode tests (Matteo Collina) [#61615](https://github.com/nodejs/node/pull/61615)
* \[[`410234adff`](https://github.com/nodejs/node/commit/410234adff)] - **test**: update WPT for url to e3c46fdf55 (Node.js GitHub Bot) [#61602](https://github.com/nodejs/node/pull/61602)
* \[[`ca64d15bc0`](https://github.com/nodejs/node/commit/ca64d15bc0)] - **test**: use the skipIfNoWatch() utility function (Luigi Pinca) [#61531](https://github.com/nodejs/node/pull/61531)
* \[[`36668f5894`](https://github.com/nodejs/node/commit/36668f5894)] - **test**: unify assertSnapshot common patterns (Chengzhong Wu) [#61590](https://github.com/nodejs/node/pull/61590)
* \[[`24977b7d3f`](https://github.com/nodejs/node/commit/24977b7d3f)] - **test**: split test-fs-watch-ignore-\* (Luigi Pinca) [#61494](https://github.com/nodejs/node/pull/61494)
* \[[`9b82fd0c80`](https://github.com/nodejs/node/commit/9b82fd0c80)] - **test**: add some validation for JSON doc output (Antoine du Hamel) [#61413](https://github.com/nodejs/node/pull/61413)
* \[[`7a95dffabb`](https://github.com/nodejs/node/commit/7a95dffabb)] - **(SEMVER-MINOR)** **test**: use fixture directories for sea tests (Joyee Cheung) [#61167](https://github.com/nodejs/node/pull/61167)
* \[[`cfceb22503`](https://github.com/nodejs/node/commit/cfceb22503)] - **test**: reveal wpt evaluation errors in status files (Chengzhong Wu) [#61358](https://github.com/nodejs/node/pull/61358)
* \[[`3e4255d828`](https://github.com/nodejs/node/commit/3e4255d828)] - **test**: forbid use of named imports for fixtures (Antoine du Hamel) [#61228](https://github.com/nodejs/node/pull/61228)
* \[[`3dfb47fe41`](https://github.com/nodejs/node/commit/3dfb47fe41)] - **test**: enforce better never-settling-promise detection (Antoine du Hamel) [#60976](https://github.com/nodejs/node/pull/60976)
* \[[`e5470526de`](https://github.com/nodejs/node/commit/e5470526de)] - **test**: ensure assertions are reached on all tests (Antoine du Hamel) [#60845](https://github.com/nodejs/node/pull/60845)
* \[[`0ff565a8d0`](https://github.com/nodejs/node/commit/0ff565a8d0)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60763](https://github.com/nodejs/node/pull/60763)
* \[[`2a5c3ff82a`](https://github.com/nodejs/node/commit/2a5c3ff82a)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60760](https://github.com/nodejs/node/pull/60760)
* \[[`8b08f90509`](https://github.com/nodejs/node/commit/8b08f90509)] - **test**: use `RegExp.escape` to improve test reliability (Antoine du Hamel) [#60803](https://github.com/nodejs/node/pull/60803)
* \[[`f1ab938cb9`](https://github.com/nodejs/node/commit/f1ab938cb9)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60728](https://github.com/nodejs/node/pull/60728)
* \[[`a4edda09e8`](https://github.com/nodejs/node/commit/a4edda09e8)] - **test**: skip tests not passing without `NODE_OPTIONS` support (Antoine du Hamel) [#60912](https://github.com/nodejs/node/pull/60912)
* \[[`b896ab4731`](https://github.com/nodejs/node/commit/b896ab4731)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60634](https://github.com/nodejs/node/pull/60634)
* \[[`44bd38b88f`](https://github.com/nodejs/node/commit/44bd38b88f)] - **test\_runner**: fix test enqueue when test file has syntax error (Edy Silva) [#61573](https://github.com/nodejs/node/pull/61573)
* \[[`2f6b136de9`](https://github.com/nodejs/node/commit/2f6b136de9)] - **test\_runner**: fix passing `expectFailure` (Moshe Atlow) [#61568](https://github.com/nodejs/node/pull/61568)
* \[[`4f906183a3`](https://github.com/nodejs/node/commit/4f906183a3)] - **test\_runner**: differentiate todo and failure styles (Moshe Atlow) [#61564](https://github.com/nodejs/node/pull/61564)
* \[[`ce4cc0a041`](https://github.com/nodejs/node/commit/ce4cc0a041)] - **(SEMVER-MINOR)** **test\_runner**: add env option to run function (Ethan Arrowood) [#61367](https://github.com/nodejs/node/pull/61367)
* \[[`bae6111785`](https://github.com/nodejs/node/commit/bae6111785)] - **(SEMVER-MINOR)** **test\_runner**: support expecting a test-case to fail (Jacob Smith) [#60669](https://github.com/nodejs/node/pull/60669)
* \[[`ebe01cc708`](https://github.com/nodejs/node/commit/ebe01cc708)] - **(CVE-2026-21637)** **tls**: route callback exceptions through error handlers (Matteo Collina) [nodejs-private/node-private#790](https://github.com/nodejs-private/node-private/pull/790)
* \[[`f7847b7fc8`](https://github.com/nodejs/node/commit/f7847b7fc8)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61759](https://github.com/nodejs/node/pull/61759)
* \[[`f1f54d4954`](https://github.com/nodejs/node/commit/f1f54d4954)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61734](https://github.com/nodejs/node/pull/61734)
* \[[`23a39fbcfe`](https://github.com/nodejs/node/commit/23a39fbcfe)] - **tools**: use ubuntu-latest runner in `notify-on-push` workflow (Antoine du Hamel) [#61742](https://github.com/nodejs/node/pull/61742)
* \[[`57d9a8af36`](https://github.com/nodejs/node/commit/57d9a8af36)] - **tools**: enforce removal of `lts-watch-*` labels on release proposals (Antoine du Hamel) [#61672](https://github.com/nodejs/node/pull/61672)
* \[[`6b5d7b2777`](https://github.com/nodejs/node/commit/6b5d7b2777)] - **tools**: use ubuntu-slim runner in meta GitHub Actions (Tierney Cyren) [#61663](https://github.com/nodejs/node/pull/61663)
* \[[`edf27c4285`](https://github.com/nodejs/node/commit/edf27c4285)] - **tools**: add LIEF to license builder (Chengzhong Wu) [#61523](https://github.com/nodejs/node/pull/61523)
* \[[`b48012f99e`](https://github.com/nodejs/node/commit/b48012f99e)] - **tools**: enforce trailing commas in `test/es-module` (Antoine du Hamel) [#60891](https://github.com/nodejs/node/pull/60891)
* \[[`21b84fcf7b`](https://github.com/nodejs/node/commit/21b84fcf7b)] - **tools**: enforce trailing commas in `test/sequential` (Antoine du Hamel) [#60892](https://github.com/nodejs/node/pull/60892)
* \[[`38c6db9b2f`](https://github.com/nodejs/node/commit/38c6db9b2f)] - **tools,win**: upgrade install additional tools to Visual Studio 2026 (Mike McCready) [#61562](https://github.com/nodejs/node/pull/61562)
* \[[`5f18ad31e2`](https://github.com/nodejs/node/commit/5f18ad31e2)] - **(SEMVER-MINOR)** **util**: add convertProcessSignalToExitCode utility (Erick Wendel) [#60963](https://github.com/nodejs/node/pull/60963)
